...
class MainWidget(RelativeLayout):
    ...
    def generate_tiles_coordinate(self):
        ...
        # Supprimer les coordonées sortie de l'écran
    ...
    def get_lines_x_from_index(self, index):
    ...
    def get_lines_y_from_index(self, index):
    ...
    def get_tile_coordinates(self, ti_x, ti_y):
        ...
        x = self.get_lines_x_from_index(ti_x)
        y = self.get_lines_y_from_index(ti_y)
        return x, y
    ...
    def update_vertical_lines(self):
        ...
        for i in range(start_index, start_index + self.V_NB_LINES):
            line_x = self.get_lines_x_from_index(i)
    ...
    def update_horizontal_lines(self):
        ...
        xmin = self.get_lines_x_from_index(start_index)
        xmax = self.get_lines_x_from_index(end_index)

        for i in range(0, self.H_NB_LINES):
            line_y = self.get_lines_y_from_index(i)
